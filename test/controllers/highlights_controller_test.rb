...
class HighlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post highlights_url, params: { highlight: { excerpts: @highlight.excerpts, speech_id: @highlight.speech_id, user_id: @highlight.user_id } }
    end
  ...
  test "should update highlight" do
    patch highlight_url(@highlight), params: { highlight: { excerpts: @highlight.excerpts, speech_id: @highlight.speech_id, user_id: @highlight.user_id } }
